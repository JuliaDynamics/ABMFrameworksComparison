...
A basic ABM that specifically targets simulating cellular automata. Two versions are simulated: a large, with a higher density, and a smaller, with a lower density.
