...
bash ./netlogo/netlogo-headless.sh --model "Schelling/NetLogo/Schelling.nlogo" --setup-file "Schelling/NetLogo/parameters_schelling.xml" --experiment benchmark | awk '/GO/{i++}i==2{print $3;exit}'
