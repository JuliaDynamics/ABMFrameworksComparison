...
function run_model(rng, n_sheep, n_wolves, dims, regrowth_time, sheep_reproduce, wolf_reproduce)
    world = wolfsheep_model(rng, n_sheep, n_wolves, dims, regrowth_time, sheep_reproduce, wolf_reproduce)
    step!(world, rng, 100)
end
