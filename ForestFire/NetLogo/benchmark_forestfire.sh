...
bash ABM_Framework_Comparisons-main/netlogo/netlogo-headless.sh --model "ForestFire/NetLogo/ForestFire.nlogo" --experiment benchmark | awk '/GO/{i++}i==2{print $3;exit}'
