...
bash ./netlogo/netlogo-headless.sh --model "WolfSheep/NetLogo/WolfSheep.nlogo" --setup-file "WolfSheep/NetLogo/parameters_wolfsheep.xml" --experiment benchmark | awk '/GO/{i++}i==2{print $3;exit}'
