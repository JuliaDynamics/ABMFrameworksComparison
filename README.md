...
This snippet was tested on an Ubuntu 22.04 LTS x86_64, but it should work also on other similar enviroments, copy-paste it on a bash shell to set up everything automatically for the benchmark. If you are on WSL make sure that you move to a folder inside the subsystem before running this commands:
